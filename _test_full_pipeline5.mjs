// Full end-to-end production test #5: fresh persona through the complete
// gate stack (cold-editor review + revise-once recovery, page-count gate,
// six story words, pinned distinguishing marks, cumulative sound chart).
