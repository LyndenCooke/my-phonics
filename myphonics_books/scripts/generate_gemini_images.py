...
SCENE_PROMPTS = {
    ...
    "1.6": {
        ...
        # - WALL: "a low stone garden wall made of grey stones"
        ...
        "scenes": [
            ...
            },
            {
                ...
                "name": "page3",
                "prompt": "Show the small cute cartoon orange-red fox with a fluffy white-tipped tail, pointed ears, a black nose, and tiny black dot eyes falling off a low stone garden wall made of grey stones, legs splayed out comically, looking shocked. The fox is tumbling backwards off the wall. The character from the reference image stands to the side, arms out as if trying to catch the fox, with a concerned amused expression. A sunny countryside scene with green grass, wildflowers, blue sky. Same character, same outfit (teal hoodie, dark grey leggings, green trainers), same light skin, same ginger plait, same freckles, same appearance as reference. IMPORTANT: ALL characters must have tiny solid black dot eyes - just small black filled circles like a teddy bear, NO white around them, on BOTH the girl AND the fox. Whimsical children's book illustration, hand-drawn cartoon style, soft watercolour textured backgrounds, clean black-outlined characters. No text, words, or letters in the image. Landscape orientation.",
            },
            {
                # Page 4: "Fox is on a hill. Fox fell off the hill!"
                "name": "page4",
                "prompt": "Show the small cute cartoon orange-red fox with a fluffy white-tipped tail, pointed ears, a black nose, and tiny black dot eyes rolling and tumbling down a small green grassy hill with wildflowers, legs in all directions, looking dizzy and silly. The fox is rolling like a ball down the hillside. The character from the reference image stands at the bottom of the hill with arms open ready to catch the fox, wincing and giggling. A sunny countryside scene with green grass, wildflowers, blue sky with white clouds. Same character, same outfit (teal hoodie, dark grey leggings, green trainers), same light skin, same ginger plait, same freckles, same appearance as reference. IMPORTANT: ALL characters must have tiny solid black dot eyes - just small black filled circles like a teddy bear, NO white around them, on BOTH the girl AND the fox. Whimsical children's book illustration, hand-drawn cartoon style, soft watercolour textured backgrounds, clean black-outlined characters. No text, words, or letters in the image. Landscape orientation.",
            },
            {
