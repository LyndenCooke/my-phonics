...
> **Source of truth:** `data/graphemes_by_level.json` and `data/tricky_words_by_level.json` — always check these files for definitive level data.

1. **Sound Recognition** — show graphemes, child says the sound
   - Level 1 "Starting Stories" (ALL Set 1 — 36 graphemes): s,a,t,p,i,n,m,d,g,o,c,k,ck,e,u,r,h,b,f,ff,l,ll,ss,j,v,w,x,y,z,zz,qu,ch,sh,th,ng,nk
   - Level 2 "Longer Sounds" (Set 2 — 11 graphemes): ay,ee,igh,ow,oo,ar,or,air,ir,ou,oy
   - Level 3 "New Spellings" (Early Set 3 — 10 graphemes): ea,a-e,i-e,o-e,u-e,oi,aw,ai,oa,ie — also test consonant cluster blending (CCVC, CVCC)
   - Level 4 "Building Fluency" (Later Set 3 — 6 graphemes): are,ur,er,ew,ue,ow(cow) — test fluency + multi-syllable words
   - Level 5 "Reading Together" (Final Set 3 — 6 graphemes): ore,oor,ire,ear,ure,tion — comprehension focus
   - Level 6 "Reading Champion" (Suffixes — 5 graphemes): ous,cious,tious,able,ible
...
3. **Nonsense Word Reading** — pseudo-words for pure decoding
   - Level 1: teg, mip, fod, gub, hin, chib, shog, thep, quab (all Set 1 graphemes available)
   - Level 2: oaf, eer, igh, oob, tay, mee (Set 2 vowel digraphs)
   - Level 3: blim, crog, stap, fent, bake (a-e), snoat (clusters + split digraphs)
   - Level 4: plure, bewer, snare (later Set 3 sounds)
   - Level 5: tortion, florear (final Set 3 sounds)

4. **Tricky Word Recognition** — common exception words (from `data/tricky_words_by_level.json`)
   - Level 1: the, to, I, no, go, into
   - Level 2: he, she, we, me, be, my, you, her, said, your, are, put
   - Level 3: all, like, want, call, some, what, they, do, old, was, so, washing
   - Level 4: saw, watch, their, school, where, were, small, who, tall, brother, any, fall
   - Level 5: does, could, would, anyone, over, through, once, whole, people, water
...
```json
{
  ...
  "results": {
    ...
    "tricky_words": {
      "level_1": {"tested": 6, "correct": 5},
      "level_2": {"tested": 12, "correct": 7}
    }
  },
  "recommendation": {
    "level": 2,
