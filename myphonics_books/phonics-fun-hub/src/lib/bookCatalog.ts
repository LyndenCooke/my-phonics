...
export const BOOK_CATALOG: CatalogBook[] = [
  ...
  { level: 2, sub_level: "L2.6", title: "The Night Fair", slug: "the-night-fair", focus_sounds: ["ay","ee","igh","ow","oo","ar","or","air","ir","ou","oy"], tricky_words: ["the","I","to","we","go","my"], story_words: [], cover_image_url: null, pdf_url: null, page_count: 24, sort_order: 26, is_free_sample: false, is_published: true },
