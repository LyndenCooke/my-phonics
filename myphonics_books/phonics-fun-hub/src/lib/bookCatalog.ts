...
export const BOOK_CATALOG: CatalogBook[] = [
  ...
  { level: 2, sub_level: "L2.2", title: "Hot Food, Cool Moon", slug: "hot-food-cool-moon", focus_sounds: ["ow","oo"], tricky_words: ["you","said","your"], story_words: [], cover_image_url: null, pdf_url: null, page_count: 24, sort_order: 22, is_free_sample: false, is_published: true },
