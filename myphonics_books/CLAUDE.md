...
### Level 2: Longer Sounds (5 books — 4 complete, 1 remaining)
| Sub | Focus Sounds | Title | Culture | Status |
|-----|--------------|-------|---------|--------|
| L2.1 | ay, ee, igh | The Night Light | Japan | ✅ |
| L2.2 | ow, oo | Moo at the Zoo | Zoo (generic) | ✅ |
| L2.3 | ar, or | Morning on the Farm | Kenya | ✅ |
...
| Sub | Focus Sounds | Title | Culture | Status |
|-----|--------------|-------|---------|--------|
| L4.1 | ur, er | The Purple Purse | Istanbul, Turkey | ✅ (ULTIMATE) |
| L4.2 | are, ow (cow) | The Brown Owl | British woodland | ✅ |
| L4.3 | ew, ue | The New Glue | Oaxaca, Mexico | ✅ |
| L4.4 | review | How Now? | Putrajaya, Malaysia | ✅ |

### Level 5: Reading Together (4 books — 2 complete, 2 remaining)
| Sub | Focus Sounds | Title | Culture | Status |
|-----|--------------|-------|---------|--------|
| L5.1 | ire, ore | Before the Shore | North London Jewish | ✅ |
| L5.2 | ear, oor | Near the Door | Stockholm, Sweden | ✅ |
| L5.3 | ure, tion | TBD | **Jaipur, India** | 🔲 |
| L5.4 | review | TBD | **Salvador, Brazil** | 🔲 |

### Level 6: Reading Champion (4 books — 0 complete, 4 remaining)
| Sub | Focus Sounds | Title | Culture | Status |
|-----|--------------|-------|---------|--------|
| L6.1 | ous | TBD | **Cairo, Egypt** | 🔲 |
| L6.2 | able, ible | TBD | **Guilin, China** | 🔲 |
| L6.3 | cious, tious | TBD | **Amalfi Coast, Italy** | 🔲 |
| L6.4 | review | TBD | **Blue Mountains, Australia** | 🔲 |

**Full plan for all remaining books (culture, theme, structure, story idea) is in `PRODUCTION_CHECKLIST.md` and `data/story_summaries.json`.**
