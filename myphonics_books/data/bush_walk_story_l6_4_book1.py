...
BUSH_WALK_STORY_BOOK1 = {
    "L6_4_B1": {
        ...
        "story_pages": [
            {
                ...
                "image_prompt": (
                    ...
                    "#B5734A, red t-shirt, khaki shorts, brown hiking boots, small backpack) sits on "
                    "a rock beside the trail, drawing quietly in a small notebook. "
                    "Australian dad (40s, skin #D4A574, short brown hair, beard, khaki hiking shirt, "
                    "cargo shorts, brown sunhat) stands behind them with a water bottle, smiling. "
                    "Bright morning sunlight through eucalyptus canopy. "
            ...
            },
            {
                ...
                "image_prompt": (
                    ...
                    "her beside a mossy fallen log, peering at something small near the ground, "
                    "notebook open in one hand. "
                    "Sandstone cliffs visible through gaps in the trees, with blue haze beyond. "
                    "Whimsical children's book illustration style, flat colour with soft watercolour "
                    "texture. Eyes: tiny solid black dots ONLY — no white, no highlights. "
                    "No text in image. Landscape orientation."
                ),
            },
            {
                ...
                "image_prompt": (
                    ...
                    "curious expression. His notebook is tucked under one arm. "
                    "Dense eucalyptus bush on both sides of the trail, with ferns and undergrowth. "
                    "Soft light filtering through the canopy. A faint suggestion of movement "
                    "deep in the bush (a shadow among ferns). "
                    "Whimsical children's book illustration style, flat colour with soft watercolour "
                    "texture. Eyes: tiny solid black dots ONLY — no white, no highlights. "
                    "No text in image. Landscape orientation."
                ),
            ...
            },
            {
                ...
                "image_prompt": (
                    ...
                    "Soft golden light. Eucalyptus forest all around. "
                    "Whimsical children's book illustration style, flat colour with soft watercolour "
                    "texture. Eyes: tiny solid black dots ONLY — no white, no highlights. "
                    "No text in image. Landscape orientation."
                ),
            ...
            },
            {
                ...
                "image_prompt": (
                    ...
                    "Soft warm lamp light inside. A hiking backpack and boots visible by the door. "
                    "Whimsical children's book illustration style, flat colour with soft watercolour "
                    "texture. Eyes: tiny solid black dots ONLY — no white, no highlights. "
                    "No text in image. Landscape orientation."
                ),
        ...
        "character": {
            ...
            "outfit": (
                "Green t-shirt, khaki shorts, brown hiking boots, small backpack. "
        ...
        "side_characters": {
            "tom": {
                ...
                "outfit": "Red t-shirt, khaki shorts, brown hiking boots, small backpack.",
                "notes": (
