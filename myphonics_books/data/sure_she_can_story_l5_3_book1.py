...
SURE_SHE_CAN_STORY_BOOK1 = {
    "L5_3_B1": {
        ...
        "cover_prompt": (
            "Indian girl (6 years old, medium-dark South Asian skin #8B6B4A, "
        ...
        "questions": [
            ...
            {
                "category": "Thinking",
                "text": "Why did the girl want to give up? What changed her mind?",
            },
            {
                "category": "Words",
            ...
            {
                "category": "What next",
                "text": "If you could fly a kite anywhere in the world, where would you go?",
            },
        ],
        ...
        "character": {
            ...
            "age": "6 years old",
            "appearance": (
                "Medium-dark South Asian skin (#8B6B4A). Dark black hair (#0D0D0D) "
                "in two braids tied with small yellow ribbons. Bright expressive eyes "
                "(tiny solid black dots). Warm, animated face."
            ),
            "outfit": (
