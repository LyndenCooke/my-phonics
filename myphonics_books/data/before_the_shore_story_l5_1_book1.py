...
SECRET_SHORE_STORY_BOOK1 = {
    "L5_1_B1": {
        ...
        "story_pages": [
            {
                ...
                "image_prompt": "An Orthodox Jewish boy with kippah and payot sits tired on a park bench, picking up a smooth grey stone. Victorian terraced houses in background, autumn leaves on ground. Landscape orientation.",
            },
            {
                "page_number": 2,
                ...
                "image_prompt": "The boy sits on the park bench with eyes closed peacefully, holding a smooth stone in cupped hands. Dreamy atmosphere suggesting memory. Park trees around him. Landscape orientation.",
            },
            {
                "page_number": 3,
                ...
                "image_prompt": "FLASHBACK — warmer golden tones. The boy runs on a sandy British beach with Orthodox Jewish Dad (black hat, long coat, beard). Mum (teal dress, headscarf) watches nearby. Small campfire visible. Waves behind. Landscape orientation.",
            },
            {
                "page_number": 4,
                ...
                "image_prompt": "FLASHBACK — warmer golden tones. The boy crouches by a rock pool holding pink and white shells. Mum (teal dress, headscarf) kneels beside him helping thread shells onto wire. Rocky shore setting. Both smiling. Landscape orientation.",
            },
            {
                "page_number": 5,
                ...
                "image_prompt": "FLASHBACK — warmer golden tones. The boy picks up a smooth grey stone from the shore edge, smiling. Orthodox Jewish Dad (black hat, long coat) gestures encouragingly. Calm sea behind them. Landscape orientation.",
            },
            {
                "page_number": 6,
                ...
                "image_prompt": "PRESENT — cooler autumn tones. The boy sits up on the park bench, eyes open, holding a grey stone up to the light. Sunlight catches the stone. Victorian houses in background. Autumn leaves. He looks happy and thoughtful. Landscape orientation.",
            },
            {
                "page_number": 7,
                ...
                "image_prompt": "The boy sits at a wooden table inside a cosy home. Two smooth grey stones and thin wire on the table. He carefully bends wire to make loops. Family photos on wall behind. Concentrated expression. Landscape orientation.",
            },
            {
                "page_number": 8,
                ...
                "image_prompt": "Mum (teal dress, headscarf) receives the wire-and-stone gift from the boy. She holds up the two stones on wire, smiling warmly. The boy looks proud. She attaches them to her handbag. Cosy home interior. Landscape orientation.",
            },
        ],
        "cover_prompt": "An Orthodox Jewish boy (kippah, white shirt, dark trousers, payot) sits on a park bench holding a smooth stone up to the light with wonder. Behind him, a split scene: London park with Victorian houses on one side, beach shore with waves on the other. Portrait orientation.",
        "story_words": ["shore", "stone", "before", "wire", "more", "fire"],
        "tricky_words_used": ["the", "to", "he", "was", "said", "she"],
        ...
        "questions": [
            {"category": "Finding", "text": "Where did the boy go with his family?"},
            {"category": "Thinking", "text": "Why did the boy make a gift for Mum?"},
        ...
        "side_characters": {
            ...
            "mum": {
                "name": "Orthodox Jewish Mum",
                "appearance": "Light olive skin, warm expression",
                "outfit": "Beige tichel (headscarf) covering hair, modest long-sleeved dark teal dress below knee, low-heeled black shoes",
            },
        },
        "cultural_notes": {
