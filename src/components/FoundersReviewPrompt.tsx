...
import { Star, MessageCircle, Sparkles, Check } from 'lucide-react';
...
export default function FoundersReviewPrompt() {
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-fuchsia-50 to-pink-50 border-2 border-fuchsia-300 p-5 mb-6 shadow-card">
      ...
      <button
        ...
        className="w-full py-3 rounded-xl bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-extrabold text-sm shadow-button active:scale-[0.97] transition-transform disabled:opacity-60 disabled:active:scale-100 flex items-center justify-center gap-2"
      >
        {submitting ? 'Sending…' : <>Send feedback <Check className="w-4 h-4" /></>}
      </button>
    </div>
  );
}
