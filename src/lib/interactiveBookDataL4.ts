...
export const BOOK_L4_2_PAGES: InteractivePage[] = [
  ...
  // Page 3
  {
    ...
    words: [
      ...
      word('and', 'and', ['a','n','d']), word('stared', 'stared', ['s','t','are','d']),
      word('up', 'up', ['u','p']), word('at', 'at', ['a','t']), tricky('the', 'the'),
      word('bare', 'bare', ['b','are']),
      word('branches.', 'branches', ['b','r','a','n','ch','e','s']),
      word('"Look!"', 'look', ['l','oo','k']), word('she', 'she', ['sh','ee']),
      tricky('said.', 'said'), tricky('I', 'I'),
      word('stared', 'stared', ['s','t','are','d']), word('too.', 'too', ['t','oo']),
      tricky('Something', 'something'), tricky('was', 'was'), word('up', 'up', ['u','p']),
      word('there', 'there', ['th','ere']), word('in', 'in', ['i','n']),
      tricky('the', 'the'), word('dark.', 'dark', ['d','ar','k']), tricky('What', 'what'),
  ...
  // Page 4
  {
    ...
    words: [
      word('Then', 'then', ['th','e','n']), tricky('I', 'I'),
      word('saw', 'saw', ['s','aw']), word('it.', 'it', ['i','t']), word('A', 'a', ['a']),
      word('big', 'big', ['b','i','g']), word('brown', 'brown', ['b','r','ow','n']),
      word('owl!', 'owl', ['ow','l']), word('It', 'it', ['i','t']),
      word('sat', 'sat', ['s','a','t']), word('high', 'high', ['h','igh']),
      word('up', 'up', ['u','p']), word('on', 'on', ['o','n']), word('a', 'a', ['a']),
      word('bare', 'bare', ['b','are']), word('branch', 'branch', ['b','r','a','n','ch']),
      word('and', 'and', ['a','n','d']), word('stared', 'stared', ['s','t','are','d']),
      word('right', 'right', ['r','igh','t']), word('down', 'down', ['d','ow','n']),
      word('at', 'at', ['a','t']), tricky('me.', 'me'), word('How', 'how', ['h','ow']),
      word('rare!', 'rare', ['r','are']), tricky('I', 'I'),
      word('stared', 'stared', ['s','t','are','d']), word('back', 'back', ['b','a','ck']),
      word('but', 'but', ['b','u','t']), tricky('I', 'I'),
      word('did', 'did', ['d','i','d']), word('not', 'not', ['n','o','t']),
      word('dare', 'dare', ['d','are']), tricky('to', 'to'),
      word('get', 'get', ['g','e','t']), tricky('close.', 'close'),
    ],
  ...
  // Page 5
  {
    ...
    words: [
      ...
      word('down', 'down', ['d','ow','n']), word('from', 'from', ['f','r','o','m']),
      tricky('the', 'the'), word('branch.', 'branch', ['b','r','a','n','ch']),
      word('Wow!', 'wow', ['w','ow']), tricky('I', 'I'),
      word('froze.', 'froze', ['f','r','o-e','z']), tricky('I', 'I'),
      word('did', 'did', ['d','i','d']), word('not', 'not', ['n','o','t']),
      word('dare', 'dare', ['d','are']), tricky('to', 'to'),
      word('make', 'make', ['m','a-e','k']), word('a', 'a', ['a']),
  ...
  // Page 6
  {
    ...
    words: [
      ...
      word('a', 'a', ['a']), word('branch', 'branch', ['b','r','a','n','ch']),
      word('next', 'next', ['n','e','x','t']), tricky('to', 'to'), word('a', 'a', ['a']),
      word('hole', 'hole', ['h','o-e','l']), word('high', 'high', ['h','igh']),
      word('in', 'in', ['i','n']), tricky('the', 'the'),
      word('tree.', 'tree', ['t','r','ee']), word('Out', 'out', ['ou','t']),
      word('came', 'came', ['c','a-e','m']), word('soft', 'soft', ['s','o','f','t']),
      word('cheeps.', 'cheeps', ['ch','ee','p','s']),
      word('"Owlets!"', 'owlets', ['ow','l','e','t','s']), tricky('said', 'said'),
      word('Mum.', 'mum', ['m','u','m']), word('"She', 'she', ['sh','ee']),
      word('must', 'must', ['m','u','s','t']), word('look', 'look', ['l','oo','k']),
      word('after', 'after', ['a','f','t','er']), word('them!"', 'them', ['th','e','m']),
      tricky('I', 'I'), word('peeked', 'peeked', ['p','ee','k','ed']),
      word('and', 'and', ['a','n','d']), word('saw', 'saw', ['s','aw']),
      word('fluffy', 'fluffy', ['f','l','u','ff','y']),
      word('white', 'white', ['wh','i-e','t']), tricky('faces', 'faces'),
  ...
  // Page 7
  {
    ...
    words: [
      ...
      word('with', 'with', ['w','i','th']), word('a', 'a', ['a']),
      ...
      word('loudly.', 'loudly', ['l','ou','d','l','ee']), tricky('What', 'what'),
      word('a', 'a', ['a']), word('rare', 'rare', ['r','are']),
      word('sight!', 'sight', ['s','igh','t']), word('Mum', 'mum', ['m','u','m']),
      word('and', 'and', ['a','n','d']), tricky('I', 'I'),
      word('shared', 'shared', ['sh','are','d']), word('a', 'a', ['a']),
