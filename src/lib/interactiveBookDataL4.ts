...
export const BOOK_L4_1_PAGES: InteractivePage[] = [
  // ── COVER ──
  { type: 'cover', title: 'The Purple Purse', subtitle: 'Level 6 · Building Fluency', imageUrl: '/illustrations/4_1/cover.png' },
  ...
  // ── VOCAB PREVIEW ──
  {
    type: 'vocab_preview',
    words: [
      word('purple', 'purple', ['p','ur','p','le']),
      word('purse', 'purse', ['p','ur','se']),
  ...
  // Page 1
  {
    ...
    words: [
      tricky('My', 'my'), word('purple', 'purple', ['p','ur','p','le']),
      word('purse', 'purse', ['p','ur','se']), tricky('was', 'was'),
      word('gone!', 'gone', ['g','o','n']),
      tricky('I', 'I'), word('turned', 'turned', ['t','ur','n','ed']),
      tricky('my', 'my'), word('pockets', 'pockets', ['p','o','ck','e','t','s']),
      word('inside', 'inside', ['i','n','s','i-e','d']), word('out,', 'out', ['ou','t']),
  ...
  // Page 2
  {
    ...
    words: [
      word('Dad', 'dad', ['d','a','d']), word('came', 'came', ['c','a-e','m']),
  ...
  // Page 4
  {
    ...
    words: [
      ...
      word('pay!', 'pay', ['p','ay']),
      tricky('I', 'I'), word('turned', 'turned', ['t','ur','n','ed']),
      tricky('away,', 'away'), word('sad.', 'sad', ['s','a','d']),
    ],
  ...
  // Page 5
  {
    ...
    words: [
      ...
      tricky('we', 'we'), word('passed', 'passed', ['p','a','ss','ed']),
      ...
      tricky('tall', 'tall'), word('garden', 'garden', ['g','ar','d','e','n']),
      word('walls.', 'walls', ['w','a','ll','s']),
      tricky('I', 'I'), word('started', 'started', ['s','t','ar','t','e','d']),
      tricky('to', 'to'), word('give', 'give', ['g','i-e','v']),
      word('up.', 'up', ['u','p']),
    ],
  ...
  // Page 6
  {
    ...
    words: [
      ...
      word('market', 'market', ['m','ar','k','e','t']), tricky('lady', 'lady'),
      word('held', 'held', ['h','e','l','d']), word('up', 'up', ['u','p']),
      tricky('a', 'a'), word('purple', 'purple', ['p','ur','p','le']),
      word('purse!', 'purse', ['p','ur','se']),
      tricky('"I', 'I'), word('found', 'found', ['f','ou','n','d']),
  ...
  // Page 7
  {
    ...
    words: [
      tricky('I', 'I'), word('turned', 'turned', ['t','ur','n','ed']),
      tricky('the', 'the'), word('purse', 'purse', ['p','ur','se']),
      word('over.', 'over', ['o','v','er']),
      ...
      word('out,', 'out', ['ou','t']), tricky('smiling.', 'smiling'),
    ],
  ...
  // Page 8
  {
    ...
    words: [
      ...
      tricky('I', 'I'), tricky('walked', 'walked'),
      word('home', 'home', ['h','o-e','m']), word('in', 'in', ['i','n']),
...
export const BOOK_L4_2_PAGES: InteractivePage[] = [
  // ── COVER ──
  { type: 'cover', title: 'The Brown Owl', subtitle: 'Level 6 · Building Fluency', imageUrl: '/illustrations/4_2/cover.png' },
  ...
  // ── STORY PAGES ──
  // Page 1
      { type: 'story', sentences: ['It was getting dark.', 'From deep in the trees came a loud howl, then a growl.', 'What was that?', 'I stared out the window but all I saw were shadows.'],
    words: [
      cvc('It', 'it'),
      tricky('was', 'was'),
      pw('getting', 'getting', ['g', 'e', 'tt', 'i', 'ng']),
      pw('dark.', 'dark', ['d', 'ar', 'k']),
      cvc('From', 'from'),
      pw('deep', 'deep', ['d', 'ee', 'p']),
      cvc('in', 'in'),
      ...
      pw('saw', 'saw', ['s', 'aw']),
      tricky('were', 'were'),
      pw('shadows.', 'shadows', ['sh', 'a', 'd', 'ow', 's']),
    ],
    imageUrl: '/illustrations/4_2/page1.png', audioUrl: '/sounds/sentences/L4_2_p1.mp3' },
  { type: 'story', sentences: ['"Can we go and look?" I asked Mum.', 'She got me my thick coat and boots.', 'We set off down the dark path together.', 'The air was cool on my bare cheeks.'],
    words: [
      cvc('"Can', 'can'),
      tricky('we', 'we'),
      tricky('go', 'go'),
      ...
      tricky('my', 'my'),
      pw('bare', 'bare', ['b', 'are']),
      pw('cheeks.', 'cheeks', ['ch', 'ee', 'k', 's']),
    ],
    imageUrl: '/illustrations/4_2/page2.png', audioUrl: '/sounds/sentences/L4_2_p2.mp3' },
  { type: 'story', sentences: ['Then Mum stopped and stared up at the bare branches.', '"Look!" she said.', 'I stared too.', 'Something was up there in the dark.', 'What was it?'],
    words: [
      pw('Then', 'then', ['th', 'e', 'n']),
      cvc('Mum', 'mum'),
  ...
  { type: 'story', sentences: ['Then I saw it.', 'A big brown owl!', 'It sat high up on a bare branch and stared right down at me.', 'How rare!', 'I stared back but I did not dare to get close.'],
    words: [
      pw('Then', 'then', ['th', 'e', 'n']),
      tricky('I', 'I'),
      pw('saw', 'saw', ['s', 'aw']),
  ...
  { type: 'story', sentences: ['Then the owl spread its wings and swooped down from the branch.', 'Wow!', 'I froze.', 'I did not dare to make a sound.'],
    words: [
      pw('Then', 'then', ['th', 'e', 'n']),
      tricky('the', 'the'),
      pw('owl', 'owl', ['ow', 'l']),
      pw('spread', 'spread', ['s', 'p', 'r', 'ea', 'd']),
      cvc('its', 'its'),
      pw('wings', 'wings', ['w', 'i', 'ng', 's']),
      cvc('and', 'and'),
      pw('swooped', 'swooped', ['s', 'w', 'oo', 'p', 'ed']),
      pw('down', 'down', ['d', 'ow', 'n']),
      cvc('from', 'from'),
      tricky('the', 'the'),
      pw('branch.', 'branch', ['b', 'r', 'a', 'n', 'ch']),
  ...
  { type: 'story', sentences: ['The owl sat on a branch next to a hole high in the tree.', 'Out came soft cheeps.', '"Owlets!" said Mum.', '"She must look after them!" I peeked and saw fluffy white faces staring down at me.'],
    words: [
      tricky('The', 'the'),
      pw('owl', 'owl', ['ow', 'l']),
      cvc('sat', 'sat'),
      ...
      pw('came', 'came', ['c', 'a-e', 'm']),
      cvc('soft', 'soft'),
      pw('cheeps.', 'cheeps', ['ch', 'ee', 'p', 's']),
      pw('"Owlets!"', 'owlets', ['ow', 'l', 'e', 't', 's']),
      tricky('said', 'said'),
      cvc('Mum.', 'mum'),
      tricky('"She', 'she'),
      cvc('must', 'must'),
      ...
      pw('them!"', 'them', ['th', 'e', 'm']),
      tricky('I', 'I'),
      pw('peeked', 'peeked', ['p', 'ee', 'k', 'ed']),
      cvc('and', 'and'),
      pw('saw', 'saw', ['s', 'aw']),
      pw('fluffy', 'fluffy', ['f', 'l', 'u', 'ff', 'y']),
      pw('white', 'white', ['wh', 'i-e', 't']),
      pw('faces', 'faces', ['f', 'a-e', 'c', 's']),
      pw('staring', 'staring', ['s', 't', 'ar', 'i', 'ng']),
      pw('down', 'down', ['d', 'ow', 'n']),
      cvc('at', 'at'),
      tricky('me.', 'me'),
    ],
    imageUrl: '/illustrations/4_2/page6.png', audioUrl: '/sounds/sentences/L4_2_p6.mp3' },
  { type: 'story', sentences: ['The owl swooped back up with a mouse in its claws.', 'The owlets crowded round, cheeping loudly.', 'What a rare sight!', 'Mum and I shared a smile.'],
    words: [
      tricky('The', 'the'),
      pw('owl', 'owl', ['ow', 'l']),
      pw('swooped', 'swooped', ['s', 'w', 'oo', 'p', 'ed']),
      ...
      pw('with', 'with', ['w', 'i', 'th']),
      tricky('a', 'a'),
      pw('mouse', 'mouse', ['m', 'ous', 'e']),
      cvc('in', 'in'),
      cvc('its', 'its'),
      pw('claws.', 'claws', ['c', 'l', 'aw', 's']),
      tricky('The', 'the'),
      pw('owlets', 'owlets', ['ow', 'l', 'e', 't', 's']),
      pw('crowded', 'crowded', ['c', 'r', 'ow', 'd', 'ed']),
      pw('round,', 'round', ['r', 'ou', 'n', 'd']),
      pw('cheeping', 'cheeping', ['ch', 'ee', 'p', 'i', 'ng']),
      pw('loudly.', 'loudly', ['l', 'ou', 'd', 'l', 'y']),
      tricky('What', 'what'),
      tricky('a', 'a'),
      pw('rare', 'rare', ['r', 'are']),
      pw('sight!', 'sight', ['s', 'igh', 't']),
      cvc('Mum', 'mum'),
      cvc('and', 'and'),
      tricky('I', 'I'),
      pw('shared', 'shared', ['sh', 'are', 'd']),
      tricky('a', 'a'),
      pw('smile.', 'smile', ['s', 'm', 'i-e', 'l']),
    ],
    imageUrl: '/illustrations/4_2/page7.png', audioUrl: '/sounds/sentences/L4_2_p7.mp3' },
  { type: 'story', sentences: ['We went home under the stars.', '"I want to go back and care for them," I said.', 'Mum took my hand.', '"We will," she said.', 'I smiled all the way home.', 'The brown owl and her owlets were safe in the dark.'],
    words: [
      tricky('We', 'we'),
      cvc('went', 'went'),
...
export const BOOK_L4_3_PAGES: InteractivePage[] = [
  // ── COVER ──
  { type: 'cover', title: 'The New Glue', subtitle: 'Level 6 · Building Fluency', imageUrl: '/illustrations/4_3/cover.png' },
...
export const BOOK_L4_4_PAGES: InteractivePage[] = [
  // ── COVER ──
  { type: 'cover', title: 'The Cheeky Monkey', subtitle: 'Level 6 · Building Fluency', imageUrl: '/illustrations/4_4/cover.png' },
