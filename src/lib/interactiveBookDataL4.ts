...
export const BOOK_L4_1_PAGES: InteractivePage[] = [
  ...
  // ── STORY PAGES (matches PDF source `purple_purse_story_l4_1_book1.py`) ──
  // Page 1
  {
    type: 'story',
    sentences: ['"My purple purse! Where is it?"', 'The girl looked all around but it was not there.', 'She turned out all her pockets.', 'She turned to Dad.', '"I lost my purse!"'],
    words: [
      tricky('"My', 'my'), word('purple', 'purple', ['p','ur','p','l']), word('purse!', 'purse', ['p','ur','s']),
      tricky('Where', 'where'), tricky('is', 'is'), word('it?"', 'it', ['i','t']),
      tricky('The', 'the'), word('girl', 'girl', ['g','ir','l']),
      word('looked', 'looked', ['l','oo','k','ed']),
      tricky('all', 'all'), word('around', 'around', ['a','r','ou','n','d']),
      word('but', 'but', ['b','u','t']), word('it', 'it', ['i','t']),
      tricky('was', 'was'), word('not', 'not', ['n','o','t']),
      word('there.', 'there', ['th','ere']),
      tricky('She', 'she'), word('turned', 'turned', ['t','ur','n','ed']),
      word('out', 'out', ['ou','t']),
      tricky('all', 'all'), tricky('her', 'her'),
      word('pockets.', 'pockets', ['p','o','ck','e','t','s']),
      tricky('She', 'she'), word('turned', 'turned', ['t','ur','n','ed']),
      tricky('to', 'to'), word('Dad.', 'dad', ['d','a','d']),
      tricky('"I', 'I'), word('lost', 'lost', ['l','o','s','t']),
      tricky('my', 'my'), word('purse!"', 'purse', ['p','ur','s']),
    ],
    imageUrl: '/illustrations/4_1/page1.png', audioUrl: '/sounds/sentences/L4_1_p1.mp3',
  },

  // Page 2
  {
    type: 'story',
    sentences: ['"Where did you go?" said Dad.', 'The girl had to think.', '"The park first. Then the corner shop. Then the herb stand!"', 'Dad took her hand.', '"Right. Let us go and look."'],
    words: [
      tricky('"Where', 'where'), word('did', 'did', ['d','i','d']),
      tricky('you', 'you'), tricky('go?"', 'go'),
      tricky('said', 'said'), word('Dad.', 'dad', ['d','a','d']),
      tricky('The', 'the'), word('girl', 'girl', ['g','ir','l']),
      word('had', 'had', ['h','a','d']), tricky('to', 'to'),
      word('think.', 'think', ['th','i','nk']),
      tricky('"The', 'the'), word('park', 'park', ['p','ar','k']),
      word('first.', 'first', ['f','ir','s','t']),
      word('Then', 'then', ['th','e','n']), tricky('the', 'the'),
      word('corner', 'corner', ['c','or','n','er']), word('shop.', 'shop', ['sh','o','p']),
      word('Then', 'then', ['th','e','n']), tricky('the', 'the'),
      word('herb', 'herb', ['h','er','b']), word('stand!"', 'stand', ['s','t','a','n','d']),
      word('Dad', 'dad', ['d','a','d']), word('took', 'took', ['t','oo','k']),
      tricky('her', 'her'), word('hand.', 'hand', ['h','a','n','d']),
      tricky('"Right.', 'right'), tricky('Let', 'let'), tricky('us', 'us'),
      tricky('go', 'go'), word('and', 'and', ['a','n','d']),
      word('look."', 'look', ['l','oo','k']),
    ],
    imageUrl: '/illustrations/4_1/page2.png', audioUrl: '/sounds/sentences/L4_1_p2.mp3',
  },

  // Page 3
  {
    type: 'story',
    sentences: ['First, they rushed to the park.', 'She looked under the bench and in the ferns.', 'She turned the leaves and checked the bushes.', 'But no purple purse!', '"It is not at the park," she said.'],
    words: [
      word('First,', 'first', ['f','ir','s','t']), tricky('they', 'they'),
      ...
      word('ferns.', 'ferns', ['f','er','n','s']),
      tricky('She', 'she'), word('turned', 'turned', ['t','ur','n','ed']),
      tricky('the', 'the'), word('leaves', 'leaves', ['l','ea','v','s']),
      word('and', 'and', ['a','n','d']),
      word('checked', 'checked', ['ch','e','ck','ed']),
      tricky('the', 'the'), word('bushes.', 'bushes', ['b','u','sh','e','s']),
      word('But', 'but', ['b','u','t']), tricky('no', 'no'),
      word('purple', 'purple', ['p','ur','p','l']), word('purse!', 'purse', ['p','ur','s']),
      word('"It', 'it', ['i','t']), tricky('is', 'is'),
      word('not', 'not', ['n','o','t']), word('at', 'at', ['a','t']),
      tricky('the', 'the'), word('park,"', 'park', ['p','ar','k']),
      tricky('she', 'she'), tricky('said.', 'said'),
    ],
    imageUrl: '/illustrations/4_1/page3.png', audioUrl: '/sounds/sentences/L4_1_p3.mp3',
  },

  // Page 4
  {
    type: 'story',
    sentences: ['Next, the corner shop.', '"Did you see a purple purse?" she asked.', 'The man shook his head.', '"Not in my shop."', 'The girl felt her chest hurt.', 'Where was her purse?'],
    words: [
      word('Next,', 'next', ['n','e','x','t']), tricky('the', 'the'),
      word('corner', 'corner', ['c','or','n','er']), word('shop.', 'shop', ['sh','o','p']),
      tricky('"Did', 'did'), tricky('you', 'you'),
      word('see', 'see', ['s','ee']),
      ...
      tricky('his', 'his'), word('head.', 'head', ['h','ea','d']),
      tricky('"Not', 'not'), word('in', 'in', ['i','n']),
      tricky('my', 'my'), word('shop."', 'shop', ['sh','o','p']),
      tricky('The', 'the'), word('girl', 'girl', ['g','ir','l']),
      word('felt', 'felt', ['f','e','l','t']),
      tricky('her', 'her'), word('chest', 'chest', ['ch','e','s','t']),
      word('hurt.', 'hurt', ['h','ur','t']),
      tricky('Where', 'where'), tricky('was', 'was'),
      tricky('her', 'her'), word('purse?', 'purse', ['p','ur','s']),
    ],
    imageUrl: '/illustrations/4_1/page4.png', audioUrl: '/sounds/sentences/L4_1_p4.mp3',
  },

  // Page 5
  {
    type: 'story',
    sentences: ['She turned down a long street.', 'Ferns grew on old stone by a church.', 'She checked and checked.', 'But her purse was not tucked in them.', '"What if I never get it back?" she said.'],
    words: [
      tricky('She', 'she'), word('turned', 'turned', ['t','ur','n','ed']),
      ...
      word('on', 'on', ['o','n']), tricky('old', 'old'),
      word('stone', 'stone', ['s','t','o-e','n']),
      tricky('by', 'by'), tricky('a', 'a'),
      word('church.', 'church', ['ch','ur','ch']),
      tricky('She', 'she'), word('checked', 'checked', ['ch','e','ck','ed']),
      word('and', 'and', ['a','n','d']),
      word('checked.', 'checked', ['ch','e','ck','ed']),
      word('But', 'but', ['b','u','t']), tricky('her', 'her'),
      word('purse', 'purse', ['p','ur','s']),
      tricky('was', 'was'), word('not', 'not', ['n','o','t']),
      word('tucked', 'tucked', ['t','u','ck','ed']),
      word('in', 'in', ['i','n']), tricky('them.', 'them'),
      tricky('"What', 'what'), word('if', 'if', ['i','f']),
      tricky('I', 'I'), word('never', 'never', ['n','e','v','er']),
      word('get', 'get', ['g','e','t']),
      word('it', 'it', ['i','t']),
      word('back?"', 'back', ['b','a','ck']),
      tricky('she', 'she'), tricky('said.', 'said'),
    ],
    imageUrl: '/illustrations/4_1/page5.png', audioUrl: '/sounds/sentences/L4_1_p5.mp3',
  },

  // Page 6
  {
    type: 'story',
    sentences: ['Then Dad said, "The herb stand!', 'You put your purse down as you got the herbs!"', 'They rushed back.', 'The herb seller smiled.', '"Is this it?"', 'She held up a purple purse!'],
    words: [
      word('Then', 'then', ['th','e','n']), word('Dad', 'dad', ['d','a','d']),
      tricky('said,', 'said'),
      tricky('"The', 'the'), word('herb', 'herb', ['h','er','b']),
      word('stand!', 'stand', ['s','t','a','n','d']),
      tricky('You', 'you'), tricky('put', 'put'),
      tricky('your', 'your'), word('purse', 'purse', ['p','ur','s']),
      word('down', 'down', ['d','ow','n']), tricky('as', 'as'),
      tricky('you', 'you'), word('got', 'got', ['g','o','t']),
      tricky('the', 'the'), word('herbs!"', 'herbs', ['h','er','b','s']),
      tricky('They', 'they'), word('rushed', 'rushed', ['r','u','sh','ed']),
      word('back.', 'back', ['b','a','ck']),
      tricky('The', 'the'), word('herb', 'herb', ['h','er','b']),
      word('seller', 'seller', ['s','e','ll','er']),
      word('smiled.', 'smiled', ['s','m','i-e','l','ed']),
      tricky('"Is', 'is'), tricky('this', 'this'),
      word('it?"', 'it', ['i','t']),
    ...
    imageUrl: '/illustrations/4_1/page6.png', audioUrl: '/sounds/sentences/L4_1_p6.mp3',
  },

  // Page 7
  {
    type: 'story',
    sentences: ['"Yes! My purse!"', 'The girl burst with joy.', 'She turned it in her hands.', 'It was just the same — soft, like fur.', '"Thank you so much!" she said to the seller.'],
    words: [
      tricky('"Yes!', 'yes'), tricky('My', 'my'),
      word('purse!"', 'purse', ['p','ur','s']),
      tricky('The', 'the'), word('girl', 'girl', ['g','ir','l']),
      word('burst', 'burst', ['b','ur','s','t']),
      ...
      word('it', 'it', ['i','t']),
      word('in', 'in', ['i','n']),
      tricky('her', 'her'), word('hands.', 'hands', ['h','a','n','d','s']),
      word('It', 'it', ['i','t']), tricky('was', 'was'),
      word('just', 'just', ['j','u','s','t']),
      tricky('the', 'the'), word('same', 'same', ['s','a-e','m']),
      tricky('—', 'em-dash'),
      word('soft,', 'soft', ['s','o','f','t']),
      tricky('like', 'like'), word('fur.', 'fur', ['f','ur']),
      tricky('"Thank', 'thank'), tricky('you', 'you'),
      tricky('so', 'so'), word('much!"', 'much', ['m','u','ch']),
      tricky('she', 'she'), tricky('said', 'said'),
      tricky('to', 'to'), tricky('the', 'the'),
      word('seller.', 'seller', ['s','e','ll','er']),
    ],
    imageUrl: '/illustrations/4_1/page7.png', audioUrl: '/sounds/sentences/L4_1_p7.mp3',
  },

  // Page 8
  {
    type: 'story',
    sentences: ['On the way home, Dad said, "You did well. You did not stop."', 'The girl held her purple purse close.', '"I will never let it go," she said.', 'And she never did.'],
    words: [
      word('On', 'on', ['o','n']), tricky('the', 'the'),
      word('way', 'way', ['w','ay']),
      word('home,', 'home', ['h','o-e','m']),
      word('Dad', 'dad', ['d','a','d']), tricky('said,', 'said'),
      tricky('"You', 'you'), word('did', 'did', ['d','i','d']),
      word('well.', 'well', ['w','e','ll']),
      tricky('You', 'you'), word('did', 'did', ['d','i','d']),
      word('not', 'not', ['n','o','t']), word('stop."', 'stop', ['s','t','o','p']),
      tricky('The', 'the'), word('girl', 'girl', ['g','ir','l']),
      word('held', 'held', ['h','e','l','d']),
      tricky('her', 'her'), word('purple', 'purple', ['p','ur','p','l']),
      word('purse', 'purse', ['p','ur','s']), tricky('close.', 'close'),
      tricky('"I', 'I'), tricky('will', 'will'),
      word('never', 'never', ['n','e','v','er']),
      tricky('let', 'let'), word('it', 'it', ['i','t']),
      tricky('go,"', 'go'),
      tricky('she', 'she'), tricky('said.', 'said'),
      word('And', 'and', ['a','n','d']),
      tricky('she', 'she'), word('never', 'never', ['n','e','v','er']),
      word('did.', 'did', ['d','i','d']),
    ],
    imageUrl: '/illustrations/4_1/page8.png', audioUrl: '/sounds/sentences/L4_1_p8.mp3',
  },
  ...
  // ── QUIZ ──
  {
    ...
    questions: [
      ...
      { question: 'Who found the purse?',
        options: [{ label: 'The herb seller', isCorrect: true }, { label: 'Dad', isCorrect: false }, { label: 'The corner shop man', isCorrect: false }] },
      { question: 'Where did the girl search first?',
        options: [{ label: 'The park', isCorrect: true }, { label: 'A church', isCorrect: false }, { label: 'A bakery', isCorrect: false }] },
    ],
  },
  ...
  { type: 'story_ordering', items: [
    { imageUrl: '/illustrations/4_1/page1.png', label: 'My purple purse is gone!', correctIndex: 0 },
    { imageUrl: '/illustrations/4_1/page2.png', label: 'Where did you go?', correctIndex: 1 },
    { imageUrl: '/illustrations/4_1/page3.png', label: 'Not in the park.', correctIndex: 2 },
    { imageUrl: '/illustrations/4_1/page4.png', label: 'Not in the shop.', correctIndex: 3 },
    { imageUrl: '/illustrations/4_1/page6.png', label: 'The herb seller found it!', correctIndex: 4 },
    { imageUrl: '/illustrations/4_1/page8.png', label: 'Walking home, purse safe.', correctIndex: 5 },
  ] },
...
export const BOOK_L4_2_PAGES: InteractivePage[] = [
  ...
  // Page 1
  {
    ...
    words: [
      ...
      word('in', 'in', ['i','n']), tricky('the', 'the'),
      word('trees', 'trees', ['t','r','ee','s']), word('came', 'came', ['c','a-e','m']),
    ...
    imageUrl: '/illustrations/4_2/page1.png', audioUrl: '/sounds/sentences/L4_2_p1.mp3',
  },
  ...
  // Page 2
  {
    ...
    words: [
      ...
      word('asked', 'asked', ['a','s','k','ed']), word('Mum.', 'mum', ['m','u','m']),
    ...
    imageUrl: '/illustrations/4_2/page2.png', audioUrl: '/sounds/sentences/L4_2_p2.mp3',
  },
  ...
  // Page 3
  {
    ...
    imageUrl: '/illustrations/4_2/page3.png', audioUrl: '/sounds/sentences/L4_2_p3.mp3',
  },
  ...
  // Page 4
  {
    ...
    words: [
      ...
      tricky('I', 'I'), word('wanted', 'wanted', ['w','a','n','t','e','d']),
      tricky('to', 'to'), word('get', 'get', ['g','e','t']),
      tricky('close', 'close'), word('but', 'but', ['b','u','t']),
      tricky('I', 'I'), word('did', 'did', ['d','i','d']),
      word('not', 'not', ['n','o','t']), word('dare.', 'dare', ['d','are']),
    ],
    imageUrl: '/illustrations/4_2/page4.png', audioUrl: '/sounds/sentences/L4_2_p4.mp3',
  },
  ...
  // Page 5
  {
    ...
    words: [
      ...
      word('and', 'and', ['a','n','d']), word('swooped', 'swooped', ['s','w','oo','p','ed']),
      word('down.', 'down', ['d','ow','n']),
      word('Wow!', 'wow', ['w','ow']),
      word('It', 'it', ['i','t']), word('landed', 'landed', ['l','a','n','d','e','d']),
      word('on', 'on', ['o','n']), tricky('a', 'a'),
      word('stump', 'stump', ['s','t','u','m','p']),
      tricky('close', 'close'), tricky('to', 'to'),
      word('us.', 'us', ['u','s']),
      tricky('I', 'I'), word('froze.', 'froze', ['f','r','o-e','z']),
      tricky('I', 'I'), word('did', 'did', ['d','i','d']),
      word('not', 'not', ['n','o','t']), word('dare', 'dare', ['d','are']),
      tricky('to', 'to'), word('make', 'make', ['m','a-e','k']),
      tricky('a', 'a'), word('sound.', 'sound', ['s','ou','n','d']),
    ],
    imageUrl: '/illustrations/4_2/page5.png', audioUrl: '/sounds/sentences/L4_2_p5.mp3',
  },
  ...
  // Page 6
  {
    ...
    words: [
      ...
      word('hole', 'hole', ['h','o-e','l']), word('high', 'high', ['h','igh']),
      word('in', 'in', ['i','n']), tricky('the', 'the'),
      word('tree.', 'tree', ['t','r','ee']),
      word('Out', 'out', ['ou','t']), word('came', 'came', ['c','a-e','m']),
      ...
      tricky('I', 'I'), word('peeked', 'peeked', ['p','ee','k','ed']),
      word('and', 'and', ['a','n','d']), word('saw', 'saw', ['s','aw']),
      word('fluffy', 'fluffy', ['f','l','u','ff','y']),
      word('brown', 'brown', ['b','r','ow','n']),
      tricky('faces', 'faces'),
      word('staring', 'staring', ['s','t','ar','i','ng']),
      word('down', 'down', ['d','ow','n']), word('at', 'at', ['a','t']),
      tricky('me.', 'me'),
    ],
    imageUrl: '/illustrations/4_2/page6.png', audioUrl: '/sounds/sentences/L4_2_p6.mp3',
  },
  ...
  // Page 7
  {
    ...
    words: [
      ...
      tricky('a', 'a'), word('smile.', 'smile', ['s','m','i-e','l']),
    ],
    imageUrl: '/illustrations/4_2/page7.png', audioUrl: '/sounds/sentences/L4_2_p7.mp3',
  },
  ...
  // Page 8
  {
    ...
    words: [
      ...
      word('home', 'home', ['h','o-e','m']), word('under', 'under', ['u','n','d','er']),
      tricky('the', 'the'), word('stars.', 'stars', ['s','t','ar','s']),
      tricky("'I", 'I'), word('want', 'want', ['w','a','n','t']),
      ...
      tricky('she', 'she'), tricky('said.', 'said'),
      tricky('I', 'I'), word('smiled', 'smiled', ['s','m','i-e','l','d']),
      ...
      tricky('were', 'were'), word('safe', 'safe', ['s','a-e','f']),
      word('in', 'in', ['i','n']), tricky('the', 'the'),
      word('dark.', 'dark', ['d','ar','k']),
    ],
    imageUrl: '/illustrations/4_2/page8.png', audioUrl: '/sounds/sentences/L4_2_p8.mp3',
  },
...
export const BOOK_L4_3_PAGES: InteractivePage[] = [
  ...
  // Page 1
  {
    ...
    words: [
      ...
      word('pressed', 'pressed', ['p','r','e','ss','ed']),
      word('too', 'too', ['t','oo']), word('hard!', 'hard', ['h','ar','d']),
    ],
    imageUrl: '/illustrations/4_3/page1.png', audioUrl: '/sounds/sentences/L4_3_p1.mp3',
  },
  ...
  // Page 2
  {
    ...
    words: [
      ...
      tricky('the', 'the'), tricky('hall', 'hall'),
      word('and', 'and', ['a','n','d']), word('down', 'down', ['d','ow','n']),
      tricky('the', 'the'), word('stairs!', 'stairs', ['s','t','air','s']),
    ],
    imageUrl: '/illustrations/4_3/page2.png', audioUrl: '/sounds/sentences/L4_3_p2.mp3',
  },
  ...
  // Page 3
  {
    ...
    imageUrl: '/illustrations/4_3/page3.png', audioUrl: '/sounds/sentences/L4_3_p3.mp3',
  },
  ...
  // Page 4
  {
    ...
    words: [
      ...
      word('It', 'it', ['i','t']), word('bumped', 'bumped', ['b','u','m','p','ed']),
    ...
    imageUrl: '/illustrations/4_3/page4.png', audioUrl: '/sounds/sentences/L4_3_p4.mp3',
  },
  ...
  // Page 5
  {
    ...
    words: [
      ...
      tricky('He', 'he'), word('turned', 'turned', ['t','ur','n','ed']),
    ...
    imageUrl: '/illustrations/4_3/page5.png', audioUrl: '/sounds/sentences/L4_3_p5.mp3',
  },
  ...
  // Page 6
  {
    ...
    words: [
      ...
      word('It', 'it', ['i','t']), word('jumped', 'jumped', ['j','u','m','p','ed']),
      word('on', 'on', ['o','n']), tricky('the', 'the'),
      tricky('wall', 'wall'), word('and', 'and', ['a','n','d']),
      word('bumped', 'bumped', ['b','u','m','p','ed']), tricky('a', 'a'),
      word('pot', 'pot', ['p','o','t']), word('of', 'of', ['o','f']),
      word('blue', 'blue', ['b','l','ue']), word('flowers.', 'flowers', ['f','l','ow','er','s']),
      tricky('The', 'the'), word('pot', 'pot', ['p','o','t']),
      word('started', 'started', ['s','t','ar','t','e','d']),
      tricky('to', 'to'), tricky('fall!', 'fall'),
      tricky('The', 'the'), word('girl', 'girl', ['g','ir','l']),
      ...
      word('in', 'in', ['i','n']), word('time.', 'time', ['t','i-e','m']),
    ],
    imageUrl: '/illustrations/4_3/page6.png', audioUrl: '/sounds/sentences/L4_3_p6.mp3',
  },
  ...
  // Page 7
  {
    ...
    words: [
      ...
      word('and', 'and', ['a','n','d']), word('chewed', 'chewed', ['ch','ew','ed']),
      word('its', 'its', ['i','t','s']), word('fur', 'fur', ['f','ur']),
      word('clean.', 'clean', ['c','l','ea','n']),
    ],
    imageUrl: '/illustrations/4_3/page7.png', audioUrl: '/sounds/sentences/L4_3_p7.mp3',
  },
  ...
  // Page 8
  {
    ...
    words: [
      ...
      tricky('the', 'the'), word('card', 'card', ['c','ar','d']),
      tricky('was', 'was'), tricky('finished.', 'finished'),
      word('Mum', 'mum', ['m','u','m']), word('came', 'came', ['c','a-e','m']),
      word('home', 'home', ['h','o-e','m']), word('and', 'and', ['a','n','d']),
      tricky('the', 'the'), word('girl', 'girl', ['g','ir','l']),
      word('gave', 'gave', ['g','a-e','v']), word('it', 'it', ['i','t']),
    ...
    imageUrl: '/illustrations/4_3/page8.png', audioUrl: '/sounds/sentences/L4_3_p8.mp3',
  },
...
export const BOOK_L4_4_PAGES: InteractivePage[] = [
  ...
  // Page 1
  {
    ...
    words: [
      ...
      word('pink', 'pink', ['p','i','nk']), tricky('mosque.', 'mosque'),
      word('"Wow!"', 'wow', ['w','ow']), tricky('said', 'said'),
      tricky('the', 'the'), word('boy.', 'boy', ['b','oy']),
      word('"It', 'it', ['i','t']), tricky('is', 'is'),
      tricky('so', 'so'), word('big!"', 'big', ['b','i','g']),
    ],
    imageUrl: '/illustrations/4_4/page1.png', audioUrl: '/sounds/sentences/L4_4_p1.mp3',
  },
  ...
  // Page 2
  {
    ...
    words: [
      ...
      tricky('the', 'the'), tricky('water.', 'water'),
      tricky('The', 'the'), word('blue', 'blue', ['b','l','ue']),
      word('lake', 'lake', ['l','a-e','k']), tricky('was', 'was'),
    ...
    imageUrl: '/illustrations/4_4/page2.png', audioUrl: '/sounds/sentences/L4_4_p2.mp3',
  },
  ...
  // Page 3
  {
    ...
    words: [
      ...
      tricky('A', 'a'), word('monkey!', 'monkey', ['m','o','nk','ey']),
      word('It', 'it', ['i','t']), word('sat', 'sat', ['s','a','t']),
      word('on', 'on', ['o','n']), tricky('a', 'a'),
      tricky('wall', 'wall'), word('and', 'and', ['a','n','d']),
      word('turned', 'turned', ['t','ur','n','ed']), tricky('to', 'to'),
    ...
    imageUrl: '/illustrations/4_4/page3.png', audioUrl: '/sounds/sentences/L4_4_p3.mp3',
  },
  ...
  // Page 4
  {
    ...
    words: [
      tricky('The', 'the'), word('monkey', 'monkey', ['m','o','nk','ey']),
      ...
      word('monkey', 'monkey', ['m','o','nk','ey']),
      word('just', 'just', ['j','u','s','t']),
      word('grinned', 'grinned', ['g','r','i','nn','ed']),
      word('and', 'and', ['a','n','d']), word('ran', 'ran', ['r','a','n']),
      word('on.', 'on', ['o','n']),
    ],
    imageUrl: '/illustrations/4_4/page4.png', audioUrl: '/sounds/sentences/L4_4_p4.mp3',
  },
  ...
  // Page 5
  {
    ...
    words: [
      ...
      word('tree.', 'tree', ['t','r','ee']),
      word('"Oh', 'oh', ['o']), tricky('no!', 'no'),
      tricky('Where', 'where'), word('did', 'did', ['d','i','d']),
      word('it', 'it', ['i','t']), tricky('go?"', 'go'),
    ],
    imageUrl: '/illustrations/4_4/page5.png', audioUrl: '/sounds/sentences/L4_4_p5.mp3',
  },
  ...
  // Page 6
  {
    ...
    imageUrl: '/illustrations/4_4/page6.png', audioUrl: '/sounds/sentences/L4_4_p6.mp3',
  },
  ...
  // Page 7
  {
    ...
    words: [
      ...
      word('gown', 'gown', ['g','ow','n']), word('flowed', 'flowed', ['f','l','ow','ed']),
      word('in', 'in', ['i','n']), tricky('the', 'the'),
    ...
    imageUrl: '/illustrations/4_4/page7.png', audioUrl: '/sounds/sentences/L4_4_p7.mp3',
  },
  ...
  // Page 8
  {
    ...
    imageUrl: '/illustrations/4_4/page8.png', audioUrl: '/sounds/sentences/L4_4_p8.mp3',
  },
  ...
  // ── WRITING PRACTICE ──
  { type: 'writing_practice', letters: ['ow', 'ew', 'ue', 'ur', 'er', 'are'] },
