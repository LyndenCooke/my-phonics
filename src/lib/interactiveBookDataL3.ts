...
export const BOOK_L3_1_PAGES: InteractivePage[] = [
  // ── COVER ──
  {
    ...
    subtitle: 'Level 5 · New Spellings',
...
export const BOOK_L3_3_PAGES: InteractivePage[] = [
  { type: 'cover', title: 'Reach for the Treat!', subtitle: 'Level 5 · New Spellings', imageUrl: '/illustrations/3_3/cover.png' },
...
export const BOOK_L3_4_PAGES: InteractivePage[] = [
  ...
  // Page 1
      { type: 'story', sentences: ['Mum got her coat.', '"Let us go to the park," she said.', 'Min was so glad.', 'She got on her pink coat and ran to the door.'],
    words: [
      cvc('Mum', 'mum'),
      cvc('got', 'got'),
      tricky('her', 'her'),
  ...
  { type: 'story', sentences: ['Out on the street, Mum pointed up.', '"Look at that tall block!" she said.', 'Min saw a big red bus zoom past.'],
    words: [
      pw('Out', 'out', ['ou', 't']),
      cvc('on', 'on'),
      tricky('the', 'the'),
  ...
  { type: 'story', sentences: ['At the park, Min saw a soft grey cat.', 'The cat had a small white paw and bright eyes.', '"Hello, cat!" said Min with a grin.'],
    words: [
      cvc('At', 'at'),
      tricky('the', 'the'),
      pw('park,', 'park', ['p', 'ar', 'k']),
  ...
  { type: 'story', sentences: ['Min hopped on a stone in a stream.', 'She spotted a bright coin in the soil!', '"Look, Mum!" she said.', 'She picked it up and held it tight.'],
    words: [
      cvc('Min', 'min'),
      pw('hopped', 'hopped', ['h', 'o', 'pp', 'ed']),
      cvc('on', 'on'),
      tricky('a', 'a'),
      pw('stone', 'stone', ['s', 't', 'o-e', 'n']),
      cvc('in', 'in'),
      tricky('a', 'a'),
      pw('stream.', 'stream', ['s', 't', 'r', 'ea', 'm']),
      tricky('She', 'she'),
  ...
  { type: 'story', sentences: ['They went up a steep hill.', 'From the top, Min saw the whole town.', 'Mum pointed at the bright bend in the river.'],
    words: [
      tricky('They', 'they'),
      cvc('went', 'went'),
      cvc('up', 'up'),
      tricky('a', 'a'),
      pw('steep', 'steep', ['s', 't', 'ee', 'p']),
      pw('hill.', 'hill', ['h', 'i', 'll']),
      cvc('From', 'from'),
      tricky('the', 'the'),
      cvc('top,', 'top'),
  ...
  { type: 'story', sentences: ['All at once — a hawk!', 'A big brown hawk flapped past.', 'It had sharp claws and wide wings.', 'Min looked up.', 'Her jaw dropped!'],
    words: [
      tricky('All', 'all'),
      cvc('at', 'at'),
      cvc('once', 'once'),
      ...
      pw('hawk', 'hawk', ['h', 'aw', 'k']),
      pw('flapped', 'flapped', ['f', 'l', 'a', 'pp', 'ed']),
      cvc('past.', 'past'),
      cvc('It', 'it'),
      cvc('had', 'had'),
      ...
      tricky('Her', 'her'),
      pw('jaw', 'jaw', ['j', 'aw']),
      pw('dropped!', 'dropped', ['d', 'r', 'o', 'pp', 'ed']),
    ],
    imageUrl: '/illustrations/3_4/page6.png', audioUrl: '/sounds/sentences/L3_4_p6.mp3' },
  { type: 'story', sentences: ['They sat on the grass to rest.', 'The hawk soared in big slow rings.', '"I saw a hawk!" said Min.', '"I will not forget!"'],
    words: [
      tricky('They', 'they'),
      cvc('sat', 'sat'),
      cvc('on', 'on'),
      tricky('the', 'the'),
      pw('grass', 'grass', ['g', 'r', 'a', 'ss']),
      tricky('to', 'to'),
      cvc('rest.', 'rest'),
      tricky('The', 'the'),
      pw('hawk', 'hawk', ['h', 'aw', 'k']),
      pw('soared', 'soared', ['s', 'oa', 'r', 'ed']),
      cvc('in', 'in'),
      cvc('big', 'big'),
      pw('slow', 'slow', ['s', 'l', 'ow']),
      pw('rings.', 'rings', ['r', 'i', 'ng', 's']),
      tricky('"I', 'I'),
      pw('saw', 'saw', ['s', 'aw']),
      tricky('a', 'a'),
      pw('hawk!"', 'hawk', ['h', 'aw', 'k']),
  ...
  { type: 'story', sentences: ['On the way home, the trees were gold.', 'Min still had her coin.', 'She smiled at Mum.', '"What a day!', 'I saw so much!"'],
    words: [
      cvc('On', 'on'),
      tricky('the', 'the'),
      pw('way', 'way', ['w', 'ay']),
...
export const BOOK_L3_5_PAGES: InteractivePage[] = [
  ...
  // Page 1
      { type: 'story', sentences: ['Kai sits on the road eating toast.', 'He spots a boat far out at sea.', 'It has a big red sail!'],
    words: [
      pw('Kai', 'kai', ['k', 'ai']),
      cvc('sits', 'sits'),
      cvc('on', 'on'),
  ...
  { type: 'story', sentences: ['Kai grabs his coat and runs!', 'Rain splats on the main road.', 'That red sail — it must be him!'],
    words: [
      pw('Kai', 'kai', ['k', 'ai']),
      cvc('grabs', 'grabs'),
      cvc('his', 'his'),
  ...
  { type: 'story', sentences: ['From the trail, Kai spots fish on the boat!', 'A fat snail blocks his path.', '"Not now, snail!" said Kai.'],
    words: [
      cvc('From', 'from'),
      tricky('the', 'the'),
  ...
  { type: 'story', sentences: ['Kai slips and slides into a drain!', 'His coat is soaked in mud.', 'He groans — the boat will not wait!'],
    words: [
      pw('Kai', 'kai', ['k', 'ai']),
      cvc('slips', 'slips'),
      cvc('and', 'and'),
      pw('slides', 'slides', ['s', 'l', 'i-e', 'd', 's']),
      tricky('into', 'into'),
      tricky('a', 'a'),
      pw('drain!', 'drain', ['d', 'r', 'ai', 'n']),
      cvc('His', 'his'),
      pw('coat', 'coat', ['c', 'oa', 't']),
      tricky('is', 'is'),
      pw('soaked', 'soaked', ['s', 'oa', 'k', 'ed']),
      cvc('in', 'in'),
      cvc('mud.', 'mud'),
      tricky('He', 'he'),
      pw('groans', 'groans', ['g', 'r', 'oa', 'n', 's']),
      tricky('—', '—'),
      tricky('the', 'the'),
      pw('boat', 'boat', ['b', 'oa', 't']),
      pw('will', 'will', ['w', 'i', 'll']),
  ...
  { type: 'story', sentences: ['He runs and runs to the coast at last!', 'The boat sails in from the sea.', 'Kai spots the red sail!'],
    words: [
      tricky('He', 'he'),
      cvc('runs', 'runs'),
      cvc('and', 'and'),
  ...
  { type: 'story', sentences: ['The boat docks with a big load of fish.', 'A man in a coat shouts out.', '"Kai!', 'Kai!"'],
    words: [
      tricky('The', 'the'),
      pw('boat', 'boat', ['b', 'oa', 't']),
      pw('docks', 'docks', ['d', 'o', 'ck', 's']),
      pw('with', 'with', ['w', 'i', 'th']),
      tricky('a', 'a'),
      cvc('big', 'big'),
      pw('load', 'load', ['l', 'oa', 'd']),
  ...
  { type: 'story', sentences: ['It is Dad!', 'Dad leaps off the boat and scoops Kai up.', 'They spin in the sun!'],
    words: [
      cvc('It', 'it'),
      tricky('is', 'is'),
      cvc('Dad!', 'dad'),
      cvc('Dad', 'dad'),
      pw('leaps', 'leaps', ['l', 'ea', 'p', 's']),
      pw('off', 'off', ['o', 'ff']),
      tricky('the', 'the'),
      pw('boat', 'boat', ['b', 'oa', 't']),
      cvc('and', 'and'),
      pw('scoops', 'scoops', ['s', 'c', 'oo', 'p', 's']),
      pw('Kai', 'kai', ['k', 'ai']),
      cvc('up.', 'up'),
      tricky('They', 'they'),
      cvc('spin', 'spin'),
  ...
  { type: 'story', sentences: ['They stroll back up the road with the fish.', 'Then Kai spots the snail!', '"How did the snail get here?" he grins.'],
    words: [
      tricky('They', 'they'),
      pw('stroll', 'stroll', ['s', 't', 'r', 'o', 'll']),
      pw('back', 'back', ['b', 'a', 'ck']),
      cvc('up', 'up'),
      tricky('the', 'the'),
      pw('road', 'road', ['r', 'oa', 'd']),
  ...
  { type: 'story_ordering', items: [
    ...
    { imageUrl: '/illustrations/3_5/page8.png', label: 'Kai spots the snail again!', correctIndex: 7 } ] },
