...
export const BOOK_L3_3_PAGES: InteractivePage[] = [
  ...
  // Page 2
  {
    ...
    words: [
      ...
      tricky('His', 'his'), w('hands', 'hands', ['h','a','n','d','s']),
  ...
  // Page 4
  {
    ...
    words: [
      ...
      tricky('to', 'to'), w('reach', 'reach', ['r','ea','ch']),
      ...
      w('up', 'up', ['u','p']), w('high.', 'high', ['h','igh']),
      w("'This", 'this', ['th','i','s']), tricky('is', 'is'),
      tricky('no', 'no'), w("good,'", 'good', ['g','oo','d']),
      tricky('she', 'she'), tricky('said.', 'said'),
    ],
  ...
  // Page 7
  {
    ...
    words: [
      ...
      tricky('the', 'the'), w('girl.', 'girl', ['g','ir','l']),
      tricky('The', 'the'), w('mango', 'mango', ['m','a','n','g','oa']),
      tricky('is', 'is'), w('plump', 'plump', ['p','l','u','m','p']),
  ...
  // Page 8
  {
    ...
    words: [
      ...
      w('that', 'that', ['th','a','t']), w('day,', 'day', ['d','ay']),
