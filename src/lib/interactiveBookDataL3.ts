...
export const BOOK_L3_2_PAGES: InteractivePage[] = [
  ...
  {
    type: 'story',
    sentences: ['We see cute stone models on a stand.', 'We see bright noodle pots.', 'The food smelt so good!'],
    words: [
      tricky('We', 'we'),
      w('see', 'see', ['s','ee']),
      w('cute', 'cute', ['c','u-e','t']),
  ...
  {
    type: 'story',
    sentences: ['Then I see the cute stone models!', 'We went past those!', 'Mum must be close!'],
    words: [
      w('Then', 'then', ['th','e','n']),
      tricky('I', 'I'),
      w('see', 'see', ['s','ee']),
  ...
  {
    type: 'story',
    sentences: ['I run past the bright lights.', 'I run past the noodle stand.', 'Then\u2026 I see Mum!'],
    words: [
      tricky('I', 'I'),
      w('run', 'run', ['r','u','n']),
      w('past', 'past', ['p','a','s','t']),
