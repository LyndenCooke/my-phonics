...
export const BOOK_L5_1_PAGES: InteractivePage[] = [
  ...
  // Page 3
  {
    ...
    words: [
      ...
      word('cold', 'cold', ['c','o-e','l','d']), word('came,', 'came', ['c','a-e','m']),
...
export const BOOK_L5_3_PAGES: InteractivePage[] = [
  ...
  // Page 2
  {
    ...
    words: [
      ...
      tricky('of', 'of'), word('paper', 'paper', ['p','a-e','p','er']),
...

  {
    ...
    words: [
      ...
      tricky('The', 'the'), word('paper', 'paper', ['p','a-e','p','er']),
...
export const BOOK_L5_4_PAGES: InteractivePage[] = [
  ...
  // Page 5
  {
    ...
    words: [
      ...
      word('us', 'us', ['u','s']),
      word('golden-brown', 'golden-brown', ['g','o-e','l','d','e','n','b','r','ow','n']),
  ...
  // Page 6
  {
    ...
    words: [
      ...
      tricky('the', 'the'), word('old', 'old', ['o-e','l','d']),
      word('colourful', 'colourful', ['c','o','l','er','f','u','l']),
