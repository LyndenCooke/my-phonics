...
export const BOOK_L5_1_PAGES: InteractivePage[] = [
  ...
  {
    type: 'story',
    sentences: ['The boy went home from the park.', 'He was tired, and his feet were sore.', 'He sat on a bench to rest.', 'Then he saw something on the path — a smooth, flat stone.', 'He reached to pick it up.'],
    words: [
      ...
      tricky('He', 'he'), word('reached', 'reached', ['r','ea','ch','ed']),
  ...
  {
    type: 'story',
    sentences: ['Before the cold came, he went with Dad to the shore.', 'The air was fresh and the sand soft.', '"Run and explore with me!" said Dad.', 'They ran along the beach and played in the waves.', 'Later, they sat by a fire and the flames jumped and flicked.'],
    words: [
      ...
      tricky('"Run', 'run'), word('and', 'and', ['a','n','d']),
      word('explore', 'explore', ['e','x','p','l','ore']),
  ...
  {
    type: 'story',
    sentences: ['The next day, he explored the rock pools.', 'He found more and more shells!', 'Dad helped him put them on a wire.', '"We can make a gift," said Dad.', 'He twisted the wire with care.', 'It looked so nice!'],
    words: [
  ...
  {
    type: 'story',
    sentences: ['He ran home to get his shore stone.', 'Now he had a pair!', 'He took some wire and made a loop for each one.', 'He would make a gift for Dad — just like before.'],
    words: [
  ...
  {
    type: 'story',
    sentences: ['He gave the stones to Dad.', '"From the shore and from the park," he said.', 'Dad smiled wide.', '"I will keep them with me," he said.', '"So I never forget."', 'He hooked them on his bag that day.'],
    words: [
      ...
      word('never', 'never', ['n','e','v','er']),
      word('forget."', 'forget', ['f','or','g','e','t']),
      tricky('He', 'he'), word('hooked', 'hooked', ['h','oo','k','ed']),
      word('them', 'them', ['th','e','m']), word('on', 'on', ['o','n']),
