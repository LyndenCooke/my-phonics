...
export const BOOK_L2_3_PAGES: InteractivePage[] = [
  ...
  // Page 5
  { type: 'story', sentences: ['I get a torch for the dark.', 'I march to the big barn.'],
    words: [
      tricky('I', 'I'), pw('get', 'get', ['g','e','t']), tricky('a', 'a'),
  ...
  // Page 6
  { type: 'story', sentences: ['It is dark in the barn.', 'I look far into the barn.', 'I see a thing!'],
    words: [
