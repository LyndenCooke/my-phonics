...
export const BOOK_CATALOG: CatalogBook[] = [
  ...
  { level: 3, sub_level: "L3.4", title: "What Min Saw", slug: "what-min-saw", focus_sounds: ["oi","aw"], tricky_words: ["said","they","what"], story_words: ["saw","hawk","claws","points","soil","stream"], cover_image_url: null, pdf_url: null, page_count: 24, sort_order: 34, is_free_sample: false, is_published: true },
