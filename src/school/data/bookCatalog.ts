...
const _RAW_BOOKS: Omit<SchoolBook, 'id'>[] = [
  ...
  { level: 4, subLevel: 'L4.2', parent6SubLevel: 'L2.2', title: 'Hot Food, Cool Moon',                slug: 'hot-food-cool-moon',             focusSounds: ['ow','oo'],                                                              trickyWords: ['you','said','your'],             storyWords: [],                                                                  sortOrder: 42, isFreeSample: false },
