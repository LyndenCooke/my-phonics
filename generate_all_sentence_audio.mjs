...
const L5_SENTENCES = {
  ...
  // L5.3 The Kite
    "L5_3_p1": "Kites filled the pure blue sky over the pink town. On the rooftop, a girl stood with Grandad near the door. She looked up and dreamed of a kite of her own. But she did not have one yet at all. Now she could learn at last.",
    "L5_3_p2": "Grandad sat with thin sticks, string, and a sheet of paper. We can make a kite, he said with a soft smile. He showed her a neat instruction card from his pocket. Are you sure you can follow it? he asked. The girl nodded and smiled, ready to start at once.",
    "L5_3_p3": "Step one, said Grandad. Lay two sticks in a cross with the long ends down. Tie a tight knot where the sticks meet in the middle. The girl tied the knot and pulled the string firm. Now wrap the string round each end, said Grandad.",
    "L5_3_p4": "Step two, said Grandad. Lay the paper flat on the frame. Wrap each side over the string and press it down. The paper slipped, and a long rip ripped right through. The girl sat near the frame and felt very sad.",
    "L5_3_p5": "She ripped the sheet and shouted, I quit, Grandad! Grandad waited, still and kind, and did not rush at all. Are you sure you want to stop now? he asked. We can try once more. I am right here with you. He rested a hand on her wrist and smiled.",
    "L5_3_p6": "The girl nodded, took a deep breath, and set a new sheet. Read the instruction again, and we go slow this time. Press each side flat before you move on. She wrapped, smoothed, and waited until the paper held firm. Grandad checked the wind on his phone and smiled at her.",
    "L5_3_p7": "At last, the kite was ready, light to hold. Grandad tied the line to the middle with a strong knot. He said, Run and let the wind pull it up. She ran, and the kite soared up high. The yellow shape rose over more roofs.",
    "L5_3_p8": "We hear cheers from a near roof as the kite turns. Grandad clapped and beamed with joy and pride. The girl shouted, Pure joy, Grandad! and waved the line high. The kite soared, and we watched the entire sky. Grandad asked, Shall we make more before we go in?",
