...
**Engine:** Text-to-image (Flux Dev, Gemini Imagen, or equivalent)

**Prompt structure:**
```
A cartoon [girl/boy] character, about [age] years old, with [skin tone] and [hair description].
[She/He] wears [full outfit description from character roster].
[She/He] has small simple oval eyes with solid dark fill (no detailed irises or highlights),
with a friendly, cheerful expression and rosy cheeks.
...
- [ ] **Face:** Matches the character roster description (skin tone, hair style, hair colour)
- [ ] **Eyes:** Small simple ovals with solid dark fill. NOT detailed eyes with irises, pupils, highlights, or eyelashes. This is the most common failure.
- [ ] **Outfit:** Correct colours and garments (red jumper and blue dungarees for L1, etc.)
...
**If ANY check fails:**
- Adjust the prompt (add emphasis to the failing element)
- Regenerate the hero image
- Maximum 3 attempts. If still failing after 3 attempts, flag the specific issue.

**Common hero failures and fixes:**
| Failure | Fix |
|---------|-----|
| Eyes have irises/pupils/highlights | Add to prompt: "IMPORTANT: eyes must be simple solid dark ovals with NO iris detail, NO pupils, NO white highlights" |
