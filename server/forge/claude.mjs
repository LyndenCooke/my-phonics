...
const EDITOR_REVIEW_SCHEMA = {
  ...
  required: ["cold_read", "story_quality", "language_quality", "object_identity", "image_text_agreement", "action_realisation", "physical_possibility", "teaching_truth", "image_physics", "safety", "phonics_presentation", "issues", "pass", "reason"],
  additionalProperties: false,
};
